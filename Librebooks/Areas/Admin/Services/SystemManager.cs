...
namespace Librebooks.Areas.Admin.Services
{
		...
		: ISystemManager
	{
		...
		public async Task<TransactionResult<CompanySetup>> InitializeAsync (int nextNumber = 1, string? numberPrefix = null, string? numberFormat = null)
		{
		...
		public async Task<DateFormat?> FindDateFormatByIdAsync (int id)
		...
		public Task<PaymentMethod?> FindPaymentMethodByIdAsync (int id)
		...
		public async Task<PaymentTerm?> FindPaymentTermByIdAsync (int id)
		...
		public async Task<ShippingMethod?> FindShippingMethodByIdAsync (int id)
		...
		public async Task<ShippingTerm?> FindShippingTermByIdAsync (int id)
		...
		public async Task<IList<BusinessSector>> FindBusinessSectorsByIdsAsync (params int[] sectorIds)
		...
		public async Task<BusinessSector?> FindBusinessSectorByIdAsync (int id)

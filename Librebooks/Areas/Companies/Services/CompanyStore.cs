...
{
	public class CompanyStore (AppDbContext context, ILogger<CompanyStore> logger, ISystemManager sysManager)
		: ICompanyStore
	{
		private readonly ISystemManager systemManager = sysManager;
		...
		public async Task<CompanyImage?> FindLogoAsync (int companyId)

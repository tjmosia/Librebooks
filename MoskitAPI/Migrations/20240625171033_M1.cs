        ...
        protected override void Up (MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code3 = table.Column<string>(type: "TEXT", maxLength: 3, nullable: true),
                    Numeric = table.Column<short>(type: "INTEGER", maxLength: 3, nullable: false),
                    Name = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    NumberPrefix = table.Column<string>(type: "TEXT", nullable: true),
                    NumberNext = table.Column<long>(type: "INTEGER", nullable: false),
                    NumberFormat = table.Column<string>(type: "TEXT", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "BLOB", rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemCompanySetup", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberPrefix = table.Column<string>(type: "TEXT", nullable: true),
                    NumberSuffix = table.Column<string>(type: "TEXT", nullable: true),
                    CurrentNumber = table.Column<string>(type: "TEXT", nullable: true),
                    RemoveLeadingZeros = table.Column<bool>(type: "INTEGER", nullable: false),
                    FootMessage = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentSetup", x => x.CompanyId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MailSettings", x => x.CompanyId);
                    table.ForeignKey(
                        name: "FK_MailSettings_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegionalSettings", x => x.CompanyId);
                    table.ForeignKey(
                        name: "FK_RegionalSettings_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegionalSettings_Country_CountryCode",
                        column: x => x.CountryCode,
                        principalTable: "Country",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RegionalSettings_Currency_CurrencyCode",
                        column: x => x.CurrencyCode,
                        principalTable: "Currency",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RegionalSettings_DateFormat_DateFormatId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CompanyId = table.Column<string>(type: "TEXT", nullable: false),
                    CompanyVATId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegionalSettings_CountryCode",
                table: "RegionalSettings",
                column: "CountryCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RegionalSettings_CurrencyCode",
                table: "RegionalSettings",
                column: "CurrencyCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RegionalSettings_DateFormatId",
                table: "RegionalSettings",
                column: "DateFormatId",
                unique: true);

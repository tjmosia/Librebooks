...
namespace OskitBlazor.Migrationss
{
    /// <inheritdoc />
        ...
        protected override void Up (MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearsInBusienss = table.Column<int>(type: "int", nullable: false),
                    BusinessSectorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true),

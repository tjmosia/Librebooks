 ...
 */
export const BlueprintProvider = ({ children, hotkeysProviderValue, ...props }) => {
    return (_jsx(PortalProvider, { ...props, children: _jsx(OverlaysProvider, { children: _jsx(HotkeysProvider, { value: hotkeysProviderValue, ...props, children: children }) }) }));
};

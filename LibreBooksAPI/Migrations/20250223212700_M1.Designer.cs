...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibreBooksAPI.Models.Entity.CompanySpace.CompanySetup", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LibreBooksAPI.Models.Entity.CustomerSpace.CustomerSetup", b =>
                {
                    b.Property<string>("CompanyId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LibreBooksAPI.Models.Entity.InventorySpace.ItemSetup", b =>
                {
                    b.Property<string>("CompanyId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LibreBooksAPI.Models.Entity.SupplierSpace.SupplierSetup", b =>
                {
                    b.Property<string>("CompanyId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LibreBooksAPI.Models.Entity.CustomerSpace.CustomerSetup", b =>
                {
                    b.HasOne("LibreBooks.Models.Entity.CompanySpace.Company", null)
                        ...
                        .HasForeignKey("LibreBooksAPI.Models.Entity.CustomerSpace.CustomerSetup", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("LibreBooksAPI.Models.Entity.InventorySpace.ItemSetup", b =>
                {
                    b.HasOne("LibreBooks.Models.Entity.CompanySpace.Company", null)
                        .WithOne("ItemSetup")
                        .HasForeignKey("LibreBooksAPI.Models.Entity.InventorySpace.ItemSetup", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("LibreBooksAPI.Models.Entity.SupplierSpace.SupplierSetup", b =>
                {
                    b.HasOne("LibreBooks.Models.Entity.CompanySpace.Company", null)
                        ...
                        .HasForeignKey("LibreBooksAPI.Models.Entity.SupplierSpace.SupplierSetup", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });

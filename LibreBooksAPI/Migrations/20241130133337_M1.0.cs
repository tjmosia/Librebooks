        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearsInBusienss = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyTaxType_TaxTypes_TaxTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanySalesTaxType", x => x.CompanyId);
                    table.ForeignKey(
                        name: "FK_CompanySalesTaxType_CompanyTaxType_CompanyTaxTypeId",
                        column: x => x.CompanyTaxTypeId,
                        principalTable: "CompanyTaxType",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CompanySalesTaxType_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanySalesTaxType_CompanyTaxTypeId",
                table: "CompanySalesTaxType",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxTypes_Name_System_Group",
                table: "TaxTypes",

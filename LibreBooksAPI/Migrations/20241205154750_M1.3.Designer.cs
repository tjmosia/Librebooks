...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibreBooks.Models.Entity.CompanySpace.CompanySalesTaxType", b =>
                {
                    b.Property<string>("CompanyId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("CompanySalesTaxType", (string)null);
                });
            ...
            modelBuilder.Entity("LibreBooks.Models.Entity.SystemSpace.TaxTypes", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LibreBooksAPI.Models.Entity.CompanySpace.CompanyLogo", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LibreBooks.Models.Entity.CompanySpace.Company", b =>
                {
                    ...
                    b.HasOne("LibreBooksAPI.Models.Entity.CompanySpace.CompanyLogo", "Logo")
                        .WithOne()
                        .HasForeignKey("LibreBooks.Models.Entity.CompanySpace.Company", "LogoId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("LibreBooks.Models.Entity.CompanySpace.CompanySalesTaxType", b =>
                {
                    b.HasOne("LibreBooks.Models.Entity.CompanySpace.Company", "Company")
                        .WithOne("SalesTaxType")
                        .HasForeignKey("LibreBooks.Models.Entity.CompanySpace.CompanySalesTaxType", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibreBooks.Models.Entity.CompanySpace.CompanyTaxType", "CompanyTaxType")
                        .WithOne("CompanySalesTaxType")
                        .HasForeignKey("LibreBooks.Models.Entity.CompanySpace.CompanySalesTaxType", "CompanyTaxTypeId")
            ...
            modelBuilder.Entity("LibreBooks.Models.Entity.CompanySpace.CompanyTaxType", b =>
                {
                    ...
                    b.HasOne("LibreBooks.Models.Entity.SystemSpace.TaxTypes", "TaxType")
                        .WithOne()
